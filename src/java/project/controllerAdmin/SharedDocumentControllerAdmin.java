 ...
 * @author DA CUOI
 */
//myDocumentControllerAdmin



@ManagedBean(name = "sharedDocumentControllerAdmin")
@ViewScoped
public class SharedDocumentControllerAdmin {
    ...
    public SharedDocumentControllerAdmin() {
        ...
        try {
            ...
            Logger.getLogger(SharedDocumentControllerAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public ShareFile getSelectedShareFile() {
        if (selectedShareFile == null) {
            selectedShareFile = new ShareFile();
        } else {
            this.getDocumentById(selectedShareFile.getIdFile());
        }
