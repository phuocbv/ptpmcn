...
import project.controller.MyDocumentController;
 ...
 * @author DA CUOI
 */
@ManagedBean(name = "myDocumentControllerAdmin")
@ViewScoped
public class MyDocumentControllerAdmin {
    ...
    private Part file;
    private String url_document = "/WebApplication2/admin/my_document_1.xhtml";
    ...
    public MyDocumentControllerAdmin() {
        ...
        try {
            ...
            Logger.getLogger(MyDocumentControllerAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        if (file != null) {
            ...
            if (!uploadFileName.equals("")) {
                ...
                if (id > 0) {
                    ...
                    FileDAO.updateShareFileForFile(d, sf);
    ...
    public void shareFile() {
        if (selectedDocument != null && accountSelected != null && accountSelected.length > 0) {
            ...
            ShareFile shareFile = ShareFileDAO.shareFileOfMy(selectedDocument, account);
...
//    }
    ...
    public void deleteDocument() {
        if (selectedDocument != null) {
            ...
            if (b) {
                listDocument.remove(selectedDocument);
