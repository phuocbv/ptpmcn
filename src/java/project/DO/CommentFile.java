...
public class CommentFile  implements java.io.Serializable {
    ...
    public CommentFile(String content, String species, int idFile, int idAccount, String createDate) {
    ...
    public CommentFile(String content, String species, int idFile, int idAccount, String createDate, String column1, String column2, String column3) {
       this.content = content;
       this.species = species;
       this.idFile = idFile;
       this.idAccount = idAccount;
    ...
    @Column(name="idcomment_file", unique=true, nullable=false)
    public Integer getIdcommentFile() {
        return this.idcommentFile;
    }
    
    public void setIdcommentFile(Integer idcommentFile) {
